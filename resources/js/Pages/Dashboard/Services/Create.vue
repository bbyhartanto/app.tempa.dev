...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
        <TenantDashboardHeader title="Add Service" :back-url="route('dashboard.services.index')" />
            ...
            <form @submit.prevent="submit" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="e.g. Haircut, Spa Package"
                    />
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="0"
                        />
                        <p class="text-xs text-gray-500 mt-1">Break/cleanup time between sessions</p>
                    </div>
                </div>
